...
A couple dozen functions are sufficient to carry out your work in Introduction to Statistical Modeling.  This page provides the names of functions, a review of modeling syntax, and some examples of use.
