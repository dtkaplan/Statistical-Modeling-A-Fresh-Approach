...
```{r errors=FALSE,message=FALSE,warning=FALSE,results="hide"}
require(mosaic, quietly=TRUE, warn.conflicts=FALSE)
```
```{r echo=FALSE,errors=FALSE,message=FALSE,warning=FALSE,results="hide"}
...
The [magic coin exercise](magic-coins.html)

### Detecting Fraud

[Coin flips](coin-flipping.html)
