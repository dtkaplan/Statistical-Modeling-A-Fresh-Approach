...
Geometrical View of Confidence Intervals
===================
...
```{r}
v = rnorm(2)
s = d(1000)*ang(rnorm(2),v)
densityplot(~result, data=s)
```

Overall result: the standard deviation of the cosine of the angle is distributed as $latex 1/sqrt(n)$.  Random vectors tend to be orthogonal.
