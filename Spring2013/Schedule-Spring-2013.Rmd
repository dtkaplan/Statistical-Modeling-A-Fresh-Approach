...
**In Class**:
* [Processing Survey Data](http://rpubs.com/dtkaplan/m155-processing-survey-data) and the template itself: [cut and paste from here](https://github.com/dtkaplan/Statistical-Modeling-A-Fresh-Approach/blob/gh-pages/Activities/SurveyProcessing.Rmd)
...
**In Class**:
* Writing up your survey report in R. [Notes](http://rpubs.com/dtkaplan/5866).  You will want to copy the raw template from here
