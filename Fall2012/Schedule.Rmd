...
[Moodle site](https://moodle.macalester.edu/course/view.php?id=1080) :: AcroScore [initial passwords](https://moodle.macalester.edu/mod/assign/view.php?id=12216) :: [RStudio server](http://www.macalester.edu/rstudio)  
...
**Review sessions**: starting Monday Sept. 10.  Held in the MSCS reading room, Olin/Rice 254 (in the middle corridor)
* Tues 8:30-10:00 pm
* Wed 4:00-5:00 pm
* Thurs 3:00-5:00 every other week -- we need to say which weeks!
* Sat 3:00-5:00 pm
...
**In-Class**:
* Table on [Marital status of active-duty forces](https://dl.dropbox.com/u/5098197/Math155/ActiveDuty_MaritalStatus.xls) from [data.gov](https://explore.data.gov/Population/Active-Duty-Marital-Status/r84k-m39h).  Hand in your sample data file [here on Moodle](https://moodle.macalester.edu/mod/assign/view.php?id=17378)
