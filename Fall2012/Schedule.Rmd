...
R: [RStudio server](http://www.macalester.edu/rstudio)  :: [Revisions to MOSAIC commands]([RStudio server](http://dtkaplan.github.com/Statistical-Modeling-A-Fresh-Approach/Errata/errata.html)  (e.g. `props` and `counts`)
