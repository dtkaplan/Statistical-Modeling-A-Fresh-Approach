...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    div(HTML('<iframe width="250" height="40" src="http://www.youtube.com/embed/yDPfEaY-j9E?rel=0&autohide=0&modestbranding=1&theme=light" frameborder="0"></iframe>'))            
  ),
  mainPanel(
     tabsetPanel(
        tabPanel("Deterministic",        
          helpText("Deterministic Part of System: vector A."),
          div(HTML('Narration: <iframe width="300" height="40" src="http://www.youtube.com/embed/FPjjFAFBHaQ?rel=0&autohide=0&modestbranding=1&theme=light" frameborder="0"></iframe>')),
        ...
        tabPanel("Measurement",
          div(HTML('Narration: <iframe width="300" height="40" src="http://www.youtube.com/embed/HNcSinU1HTU?rel=0&autohide=0&modestbranding=1&theme=light" frameborder="0" allowfullscreen></iframe>')),
        ...
        tabPanel("3-D View",
           div(HTML('Narration: <iframe width="300" height="40" src="http://www.youtube.com/embed/b06-G799Zmc?rel=0&autohide=0&modestbranding=1&theme=light" frameborder="0" allowfullscreen></iframe>')),
           checkboxInput("newvector", HTML("<span style='color:red'>Generate new sample.</span>"),value=FALSE),
        ...
        tabPanel("Conf. Interval",
          div(HTML('Narration: <iframe width="300" height="40" src="http://www.youtube.com/embed/9aalyMDN2j4?rel=0&autohide=0&modestbranding=1&theme=light" frameborder="0"></iframe>')),
          checkboxInput("newvector", HTML("<span style='color:red'>Generate new sample.</span>"),value=FALSE),
