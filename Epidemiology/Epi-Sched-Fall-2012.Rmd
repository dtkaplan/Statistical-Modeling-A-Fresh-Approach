...
* Estimation Problem 1: How many doctors do we need? `r I(QE("NumberOfDoctors"))` See the notes at the top of the document.  Background reading from [*Guesstimation*](https://moodle.macalester.edu/mod/resource/view.php?id=10350)
