...
QE <- function(name) { # Estimation problem}
  paste("<a href='http://dtkaplan/github.com/Statistical-Modeling-A-Fresh-Approach/Epidemiology/FermiProblems.html#",name,"'>link</a>",sep="")
  }
```
**Class Schedule**
...
* Estimation Problem 1: `r I(QE("ColdPrevalence"))`
...
* [A probability calculation](http://dl.dropbox.com/u/5098197/Exercises/HTML/EPI-Evaluating-Eyewitness-Evidence/EPI-Evaluating-Eyewitness-Evidence-A.html)
...
**Reading**: 
* *Know Your Chances*, Chaps 6 & 7.  Compare Chap 7 to [this commentary](this news commentary)
**Assignment**: 
* State topic for Island Project Part 2: The Analytical Topic.  Report due the last day of class
...
**In-class**:
* The Calculus of Allocating Health Resources
