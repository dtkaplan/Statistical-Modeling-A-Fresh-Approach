...
### To answer in your essay:
* How might this partially effective method of mosquito reduction affect the prevalence of dengue fever?

`r I(moodle(20498,"dengue"))`
...
* How many nurses should you request be assigned to the vaccination program?
...
`r I(moodle(20500,"NumberOfDoctors"))`
<hr>
...
### To answer in your essay: 
* What’s the probability that a single sneeze will transmit the cold to someone else in the room?
...
`r I(moodle(20501,"ColdTransmission"))`
